...
const HamburgerMenu = () => {
  ...
  return (
    <>
      ...
      <div
        className={`menu fixed top-0 left-0 w-full h-full bg-black bg-opacity-90 text-white flex flex-col justify-center items-center z-40 ${
          isOpen ? "flex" : "hidden"
        }`}
      >
        <div
